  ...
  return (
    <div className="w-full px-[30px] md:px-[72px] lg:px-[115px] py-[40px] md:py-[80px] flex flex-col md:flex-row items-start justify-between gap-10">
      <div className="w-full md:w-1/2 flex flex-col ">
        <h1 className="text-[28px] md:text-[38px] lg:text-[67px] leading-[39.2px] md:leading-[45px] lg:leading-[73px] font-semibold">
          Discover digital art & Collect NFTs
        </h1>
        <p className="text-[16px] lg:text-[22px] leading-[22.4px] lg:leading-[35px] pt-[10px] lg:pt-[20px] pb-[30px] md:pb-0">
          NFT marketplace UI created with Anima for Figma. Collect, buy and sell
          art from more than 20k NFT artists.
        </p>
        <div className="w-full  lg:pl-10 flex md:hidden">
          <HeroImage />
        </div>
        <div className="w-full py-[30px]">
          <Link href="/contact">
            <div className=" w-full md:w-[224px] flex items-center justify-center gap-[12px] bg-callToAction px-[30px] py-4   rounded-[20px]">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
              ...
              <p className=" font-semibold text-base ">Get Started</p>
            </div>
          </Link>
        </div>
        <div className="flex justify-between">
          <div>
            <p className="space-mono-bold text-[22px] lg:text-[28px]">240k+</p>
            <p className="text-[16px] lg:text-[24px]">Total Sale</p>
          </div>
          <div>
            <p className="space-mono-bold text-[22px] lg:text-[28px]">100k+</p>
      ...
      <div className="w-full md:w-1/2  lg:pl-10 hidden md:flex">
        <HeroImage />
      </div>
    </div>
  );
