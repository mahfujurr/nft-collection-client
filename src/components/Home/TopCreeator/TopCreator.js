  ...
  return (
    <div className="w-full px-[30px] md:px-[72px] lg:px-[115px] py-[40px] md:py-[80px] flex flex-col  items-start justify-between ">
      ...
      <div className="flex justify-between w-full items-end">
        ...
        />
        <div className="pb-[40px] lg:pb-[60px] hidden md:flex">
          <button className="flex items-center justify-center gap-[12px]  px-[30px] py-4 text-callToAction border-callToAction border-[2px] rounded-[20px]">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
            ...
            <p className=" font-semibold text-base ">View Rankings</p>
          </button>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[30px] justify-center items-center w-full">
        <AvatarInfo path={"/Avatar Placeholder-1.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-2.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-3.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-4.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-5.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-6.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-7.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-8.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-9.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-1.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-2.png"} name={'Keepitreal'} amount={'34.53'}/>
        <AvatarInfo path={"/Avatar Placeholder-3.png"} name={'Keepitreal'} amount={'34.53'}/>
